...
const programs = [
  {
    ...
    description: "For children between the ages of 3 months to 12 months which runs from 7:00 am till 6pm, adult to child ratio is 1:5."
  },
  {
    title: "Toddler Class (1 – 3 years)",
    time: "8:30am – 1:30pm",
    ratio: "1:4 adult-to-child",
    description: "Montessori program for children 18 to 36 months of age that runs from 8:30am - 1:30pm."
  },
  {
    title: "Early Childhood (3 – 6 years)",
    time: "8:30am – 2:00pm",
    ratio: "1:8 adult-to-child",
    description: "Montessori Curriculum for children aged 3 to 6 years of age. The section runs from 8:30am to 1:30pm"
  },
  {
    title: "Before & After-School Care (5 – 10 years)",
    description: "After School Care is offered on a when-needed basis at an accommodative cost per day or monthly."
  },
  {
    title: "Weekend Care (3 months – 10 years)",
    description: "Weekend care is available to children ages 6 months to 10 years. It begins from 10am and ends at 4:00pm. Lunch could be arranged as at when necessary for a fee. We do appreciate having as much notice as possible if your child will be attending ,so we may arrange staffing."
  }
];
...
const enrichmentPrograms = [
  {
    title: "Swimming",
    description: "Learning to swim is so important for children because it helps them to keep safe around water and keeps them fit and healthy. The children learn balance, stability and concentration. It is also a social skill that keeps with them throughout life. The children are expected to come in with their swimwear, floaters, arm bands, towel, slippers and extra clothing. Children without all these will be not allowed to take the class.",
  },
  {
    title: "Ballet",
    description: "This activity develops in our little girls grace, elegance and poise. Their angelic faces, happy and excited as they dance in their lovely tutus would make your day. This is our most common programme amongst the girls.",
  },
  {
    title: "Music",
    description: "Music is a creative ensemble that seeks to engage the senses and fosters team spirit. This class the children are taught how to play musical instruments like the Piano, Violin, Guitars,Recorders, Drums and Maracas. They are also taught theoretical music.",
  },
  {
    title: "French",
    description: "It’s never too early to introduce the child to language. Children are most sensitive to language acquisition between the ages of birth to 6 years."
  }
];
