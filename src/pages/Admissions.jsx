...
const ageGroups = [
  { label: "Infant Centre", range: "3 – 18 months" },
  { label: "Toddler Class", range: "18 – 36 months" },
    ...
    <div className="pt-24 bg-[#f9f5f1] text-[#3a3a3a]">
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-semibold text-center mb-12 text-[#545A56]">How to Enroll</h2>
